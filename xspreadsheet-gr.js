! function(t) {
  ...
  var ee = function() {
    function t(e) {
      ...
      ! function(t, e) {
        ...
        return r.prev()
      }).child(new Kt("chevron-left")), a("a", "calendar-next").on("click.stop", function() {
        return r.next()
      }).child(new Kt("chevron-right")))), a("table", "calendar-body").children(a("thead", "").child((n = a("tr", "")).children.apply(n, Jt(L("calendar.weeks").map(function(t) {
  ...
  function nn(t, e, n, r, i) {
    var o = t.sri,
      ...
      h = this.data,
      p = h.settings;
    f.save(), f.attr(Ke).translate(e + r, n + i), f.clearRect(0, 0, s, u), p.showGrid ? (h.rowEach(o, l, function(t, e, n) {
  ...
  var Nn = function(t) {
    function e(t, n) {
      ...
      var o = new Kt("align-".concat(n)),
        l = t.map(function(t) {
          return (e = "align-".concat(t), a("div", "".concat(mt, "-item")).child(new Kt(e))).on("click", function() {
  ...
  var rr = function(t) {
    ...
    return function(t, e) {
      ...
      value: function() {
        var t = this,
          n = this.tag;
        return tr(er(e.prototype), "element", this).call(this).child(new Kt(n)).on("click", function() {
          return t.click()
        })
      }
    }, {
  ...
  var Qr = function t() {
    ...
    var i = Jr(a("tr", "").children(a("td", "".concat(mt, "-border-palette-left")).child(Jr((e = a("tr", "")).children.apply(e, Zr(["all", "inside", "horizontal", "vertical", "outside"].map(function(t) {
      return Gr.call(r, t)
    }))), (n = a("tr", "")).children.apply(n, Zr(["left", "top", "right", "bottom", "none"].map(function(t) {
      return Gr.call(r, t)
  ...
  var bi = function(t) {
    ...
    return function(t, e) {
      ...
      value: function() {
        var t = this;
        return di(yi(e.prototype), "element", this).call(this).child(new Kt(this.tag)).on("click", function() {
  ...
  var Gi = function(t) {
    function e() {
      return function(t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, e), Zi(this, Ki(e).call(this, "font-size"))
    }
    var n, r, i;
    return function(t, e) {
      if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
  ...
  var Po = function(t) {
    function e() {
      ...
      return n = _o(this, (t = Co(e)).call.apply(t, [this, new Kt("formula"), "180px", !0, "bottom-left"].concat(jo(r))))
    }
    return function(t, e) {
      if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
      t.prototype = Object.create(e && e.prototype, {
  ...
  var Go = function(t) {
    function e() {
      return function(t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, e), Zo(this, Ko(e).call(this, "redo", "Ctrl+Y"))
    }
    return function(t, e) {
      if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
      t.prototype = Object.create(e && e.prototype, {
  ...
  var Pa = function() {
    function t(e, n) {
      ...
      ! function(t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, t), this.title = e, this.el = a("div", "".concat(mt, "-modal")).css("width", o).children(a("div", "".concat(mt, "-modal-header")).children(new Kt("close").on("click.stop", function() {
        return i.hide()
  ...
  function Ka(t, e) {
    ...
    n.children(a("div", "".concat(mt, "-toast-header")).children(new Kt("close").on("click.stop", function() {
  ...
  var Pl = function() {
    ...
    Al = function() {
      function t() {
        ...
        }), this.contextMenu = new Pl, this.contextMenu.itemClick = i, this.el = a("div", "".concat(mt, "-bottombar")).children(this.contextMenu.el, this.menuEl = a("ul", "".concat(mt, "-menu")).child(a("li", "").children(new Kt("add").on("click", function() {
          e.dataNames.length < 10 ? n() : Ka("tip", "it less than or equal to 10")
