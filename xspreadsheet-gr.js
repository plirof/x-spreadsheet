! function(t) {
                ...
                this.changeData(function() {
                    ...
                    if ("merge" === t) e ? n.merge() : n.unmerge();
                        ...
                        var l = o.getCellOrNew(r, a),
                            c = {};
                        if (void 0 !== l.style && (c = D.cloneDeep(i[l.style])), "format" === t) c.format = e, l.style = n.addStyle(c);
            ...
            value: function(t, e) {
                ...
                if (null !== a && a.merge) {
                    var u = it(a.merge, 2),
                        ...
                        f = u[1];
                    if (s > 0)
                        for (var h = 1; h <= s; h += 1) c += n.getHeight(t + h);
                    if (f > 0)
                        for (var y = 1; y <= f; y += 1) l += r.getWidth(e + y)
                }
                return {
                    left: i,
                    top: o,
            ...
            value: function(t, e) {
                if (-1 !== t || -1 !== e) {
                    var n = this.range,
                        ...
                        s = o - t,
                        f = a - e;
                    if (i - e > 0) this.arange = new d(r, c, o, i - 1);
                    else if (u > 0) this.arange = new d(l, i, r - 1, a);
                    else if (f < 0) this.arange = new d(r, a + 1, o, c);
                    else {
    ...
    var pe = function(t) {
            for (var e = [], n = [], r = [], i = 0, o = "", a = 1, l = 0; l < t.length; l += 1) {
                var c = t.charAt(l);
                if (" " !== c)
                    if (c >= "a" && c <= "z") r.push(c.toUpperCase());
                    else if (c >= "0" && c <= "9" || c >= "A" && c <= "Z" || "." === c) r.push(c);
                else if ('"' === c) {
                    for (l += 1;
                        '"' !== t.charAt(l);) r.push(t.charAt(l)), l += 1;
                    ...
                    if ("(" !== c && r.length > 0 && n.push(r.join("")), ")" === c) {
                        ...
                        if (2 === i) try {
                                for (var s = ye(f(n.pop()), 2), y = s[0], p = s[1], v = ye(f(n.pop()), 2), d = v[0], b = v[1], g = 0, m = d; m <= y; m += 1)
                                    for (var w = b; w <= p; w += 1) n.push(h(m, w)), g += 1;
                                n.push([u, g])
                    ...
                    else if ("," === c) 3 === i && n.push(o), i = 1, a += 1;
                    else if ("(" === c && r.length > 0) e.push(r.join(""));
                    else {
                        if (e.length > 0 && ("+" === c || "-" === c)) {
                            var O = e[e.length - 1];
                            if ("(" !== O && n.push(e.pop()), "*" === O || "/" === O)
                                for (; e.length > 0 && "(" !== (O = e[e.length - 1]);) n.push(e.pop())
                        }
                        e.push(c)
                    }
                    r = []
        ...
        de = function(t, e, n, r) {
            for (var i = [], o = 0; o < t.length; o += 1) {
                ...
                } else if ("*" === a) i.push(Number(i.pop()) * Number(i.pop()));
                else if ("/" === a) {
                    var s = i.pop();
        ...
        return e = t, (n = [{
            ...
            value: function() {
                ...
                var i = t.viewRange(),
                    ...
                    c = l.x,
                    u = l.y;
                Ge.call(this, i, n, r, o, a), Ke.call(this, i, n, r, -c, -u), Ze.call(this, "all", i, n, r, o, a),
                    function(t, e) {
                        var n = this.draw;
                        n.save(), n.attr({
                            fillStyle: "#f4f5f8"
                ...
                if (f > 0 || h > 0) {
                    ...
                    Ge.call(this, v, n, r, 0, 0), Ze.call(this, "all", v, n, r, 0, 0), Ke.call(this, v, n, r, 0, 0),
                        function(t, e, n, r) {
                            var i = this.draw,
                                o = this.data,
                                a = o.viewWidth() - t,
    ...
    function Fa(t, e) {
        ...
        "left" === e ? c > 0 && (c -= 1) : "right" === e ? (f !== c && (c = f), c < o.len - 1 && (c += 1)) : "up" === e ? l > 0 && (l -= 1) : "down" === e ? (s !== l && (l = s), l < i.len - 1 && (l += 1)) : "row-first" === e ? c = 0 : "row-last" === e ? c = o.len - 1 : "col-first" === e ? l = 0 : "col-last" === e && (l = i.len - 1), t && (n.moveIndexes = [l, c]), Wa.call(this, t, l, c),
            function() {
                var t = this.data,
                ...
                if (Math.abs(a) + c > s.width) n.move({
                    left: i + c - s.width
                });
                else {
                ...
                if (Math.abs(l) + u > s.height) e.move({
                    top: o + u - s.height - 1
                });
                else {
    ...
    function Va() {
        var t = this.tableEl,
            ...
            c = this.getRect();
        t.attr(c), e.offset(c), n.offset(l), a.css("width", "".concat(c.width, "px")), Na.call(this), Ha.call(this),
            function() {
                var t = this.selector,
                    e = this.data,
                    n = this.editor,
    ...
    function Za(t, e) {
        ...
        else if ("paintformat" === t) !0 === e ? Ba.call(this) : qa.call(this);
        else if ("clearformat" === t) Ja.call(this, "delete-cell-format");
        else if ("link" === t);
        else if ("chart" === t);
        ...
        else n.setSelectedCellAttr(t, e), "formula" !== t || n.selector.multiple() || Xa.call(this), Va.call(this)
    }
